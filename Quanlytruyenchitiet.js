...
var editMangaBtn = document.getElementById("editMangaBtn");

if(editMangaBtn){
    editMangaBtn.onclick = function(){
        localStorage.setItem("editMangaId", mangaId);
        localStorage.setItem("currentMangaId", mangaId);
        window.location.href = "ThemTr.html?edit=" + mangaId;
    };
}
